label day2:
    ...
    menu:
        ...
        "Collect river water.":
            ...
            "It’s not hard but the feeling of damp clothes sticking to your skin on the trek back to Aeternum was unbearable."
        ...
        "Prepare the dining room.":
            ...
            "Setting up the cutlery in the dining room is always easy."
            "There's actually not that many community members in Aeternum. Maybe a few dozen, and even then the number has decreased in recent times."
            "Unsure of what to do next, you lounge on one of the chairs until you notice a familiar figure peek out from the entrance. "
            $ eleanor_count += 1
            jump day2_eleanor
        "Organize the kitchen":
            show bg kitchen with dissolve
            "You curse to yourself as you rustle through the kitchen cabinets."
            "The members of Aeternum are not nearly as tidy as they are devout. Though it may not look like much, the way they leave spices and knives in a different spot than how they found it always bothered you."
        ...
        "Mop the hallways":
            ...
            "There are much worse tasks to do on Aeternum than mopping, especially during the summer."
            "The hallway of the ranch is cool, if not a bit dim. Eleanor always liked to reduce what she calls an \"excessive reliance on electricity\" where possible."
            "You're about halfway done wiping down when you run into Sarah."
            $ sarah_count += 1
            jump day2_sarah
        "Tidy the basement":
            show bg basement with dissolve
            "You don’t really know why cleaning the basement is even on the chore list at Aeternum."
            "No one really comes down here aside from Eleanor and a few other trusted devout. Even you only come here every so often."
            "In spite of this, it’s never all that dirty, just a bit cluttered."
...
label day2_eleanor:
    ...
    play sound "sfx/chopping.mp3" loop
    play loop_sound "sfx/boiling.mp3"
    ...
    menu:
        ...
        "To figure out my life. I am still getting there.":
            ...
            "You don't miss the warning tone in Eleanor's bluntness, though someone like Sarah probably would. This is just how Eleanor navigates conversation."
            "Her pleasantries aren't so much a mask as they are a part of her. Her demeanor doesn't break, it bends."
            $ bad_choice_count += 1
        "I don't know.":
            ...
            "Eleanor says the words sweetly, as if she were gently chiding a puppy. Still, you feel the sting."
            "The word 'selfish' echoes in your head as you're left to ponder such an assessment of your character."
            ...
            $ bad_choice_count += 1
    "Eleanor looks down at her reflection in the simmering broth. As she stirs over the flame, you notice that she's barely tall enough to comfortably stir such a large stockpot."
    "You almost chuckle a bit at the mental image of Eleanor needing a step stool to reach the burners."
    "Before you can entertain the thought further, Eleanor begins speaking again. Her tone is airily pleasant as always, yet still cautious and calculated."
    ...
    menu:
        ...
        "Sarah is a bit clumsy. How did you two meet?":
            ...
            "Eleanor sighs through her nose, a half laugh as she recalls the memory."
            ...
            "You've known Eleanor for a long time, but less as a friend and more as a mentor. She's taken the lead ever since you were both young."
            "Though she was a little less eerily perfect back then, she had always been an enigma, never really talking about her personal life."
            "School, friends, family, anything like that, are all things still shrouded in mystery around Eleanor."
            $ bad_choice_count += 1
        "Sarah does not belong here.":
            ...
            "You almost laugh at the irony of Eleanor scolding you for being harsh. Well, she's right in a way, you suppose - you've always been a bit more curt than others."
            "You believe what you said though, and part of you thinks that Eleanor agrees."
    ...
    menu:
        "Eleanor... This feels so sudden. I don't know if I am ready. I'm sorry.":
            ...
            "Eleanor responds calmly, as if her desired outcome is inevitable. She was born into affluence, after all."
            "You wonder briefly if anyone's ever told her 'No'."
            marcy neutral "Sure."
...
label day2_sarah:
    ...
    "She brings you to an old chaise longue, set in front of an easel holding a plain white canvas."
    ...
    menu:
        ...
        "When do you think you'll finish? I don't want to get into trouble.":
            "Sarah pops her head out the side of the canvas and looks at you with a pout, whining like a dejected puppy."
            ...
            "Her smile returns, the tip of her tongue poking out the side as she focuses on painting. You sigh, tension building in the side of your head."
            "You know you're not supposed to be here, as Eleanor's face pops in your mind."
            "In spite of your unease, you figure holding your tongue and just letting Sarah finish will get you out of this room faster than arguing."
            $ bad_choice_count += 1
    show bg basement with dissolve
    show marcy neutral at left_side with dissolve
    show sarah happy at right_side with dissolve
    ...
    menu:
        "I... I don't know. Ask Eleanor?":
            sarah terrified "Eleanor?!"
            "You watch as Sarah's hands almost fly to her face, forgetting the blade in her hand, but she stops right before she drops it."
            "Her throat bobs as she audibly gulps hard, trying to regain her composure."
            "Her whole body is shaking, her breathing is uneven, and there's something deeply... wrong behind her eyes."
            "She's staring down at the knife, yes, but she's also looking else at something beyond. A sick part inside of you wants to peer into her mind and see those thoughts, no matter how twisted or morbid."
            "You shake your head. No. NO. You're not enjoying this."
            "You want to help her, but your feet are frozen in place."
